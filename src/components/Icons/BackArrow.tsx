...
const BackArrow: FC<{ style?: CSSProperties; className?: string; onClick?: (e: any) => void; disabled?: boolean }> = ({
	style,
	className,
	onClick,
}) => {
	return (
		<svg style={style} className={className || ''} onClick={onClick} version="1.1" viewBox="0 0 512 512">
